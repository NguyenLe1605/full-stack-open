...
const Anecdote = ({anecdote}) => {
  ...
  return (
    <div>
      <h1 style={paddingStyle}>{anecdote.content} by {anecdote.author}</h1>
      <div style={paddingStyle}>has {anecdote.votes} votes</div>
      <div style={paddingStyle}>for more info see <a href={anecdote.info}>{anecdote.info}</a></div>
    </div>
  )
}
